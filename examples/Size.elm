...
chart =
  LineChart.viewCustom
    { y = Axis.default 450 "Height" .height -- Change number here to edit height
    , x = Axis.default 700 "Age" .age       -- Change number here to edit width
