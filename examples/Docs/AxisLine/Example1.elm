module Docs.AxisLine.Example1 exposing (main)
...
axisLineConfig =
  -- AxisLine.default
  -- AxisLine.rangeFrame Colors.gray
  -- AxisLine.full Colors.gray
  AxisLine.none
  -- customAxisLineConfig


customAxisLineConfig : AxisLine.Config msg
customAxisLineConfig =
