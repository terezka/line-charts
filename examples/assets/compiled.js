...
var _user$project$LineChart_Colors$blue = A3(_elm_lang$core$Color$rgb, 40, 235, 199);
...
var _user$project$LineChart_Container$Config = F4(
	function (a, b, c, d) {
		return {attributes: a, attributesSVG: b, margin: c, id: d};
	});
var _user$project$LineChart_Container$Margin = F4(
	function (a, b, c, d) {
		return {top: a, right: b, bottom: c, left: d};
	});
var _user$project$LineChart_Container$default = function (id) {
	return {
		attributes: {ctor: '[]'},
		attributesSVG: {ctor: '[]'},
		margin: A4(_user$project$LineChart_Container$Margin, 20, 140, 40, 80),
		id: id
	};
};
...
var _user$project$Internal_Junk$getLayers = F2(
	function (system, _p0) {
		var _p1 = _p0;
		return _p1._0(system);
	});
		...
		switch (_p3.ctor) {
			case 'Move':
				return _user$project$Internal_Path$Move(
					A2(_user$project$LineChart_Coordinate$toSVG, system, _p3._0));
			case 'Line':
				return _user$project$Internal_Path$Line(
					A2(_user$project$LineChart_Coordinate$toSVG, system, _p3._0));
			case 'Horizontal':
				return _user$project$Internal_Path$Horizontal(
					A2(_user$project$LineChart_Coordinate$toSVGX, system, _p3._0));
			case 'Vertical':
				return _user$project$Internal_Path$Vertical(
					A2(_user$project$LineChart_Coordinate$toSVGY, system, _p3._0));
			case 'CubicBeziers':
				return A3(
					_user$project$Internal_Path$CubicBeziers,
					A2(_user$project$LineChart_Coordinate$toSVG, system, _p3._0),
					A2(_user$project$LineChart_Coordinate$toSVG, system, _p3._1),
					A2(_user$project$LineChart_Coordinate$toSVG, system, _p3._2));
			case 'CubicBeziersShort':
				return A2(
			...
			case 'Arc':
				return A6(
					...
					_p3._3,
					_p3._4,
					A2(_user$project$LineChart_Coordinate$toSVG, system, _p3._5));
			default:
			...
			A2(
				...
				function (_p4) {
					return _user$project$Internal_Path$toString(
						A2(_user$project$Internal_Path$translate, system, _p4));
				},
				commands));
	});
...
var _user$project$Internal_Svg$gridDot = F2(
...
var _user$project$Internal_Svg$addPosition = F2(
	function (_p2, _p1) {
		var _p3 = _p2;
		var _p4 = _p1;
		return A2(_user$project$Internal_Svg$Transfrom, _p4._0 + _p3._0, _p4._1 + _p3._1);
	});
...
var _user$project$Internal_Svg$transform = function (translations) {
	var _p5 = _user$project$Internal_Svg$toPosition(translations);
	var x = _p5._0;
	var y = _p5._1;
...
var _user$project$LineChart_Junk$withinChartArea = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$svg$Svg_Attributes$clipPath(
		A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$Internal_Utils$toChartAreaId(_p1.id),
				')')));
};
...
var _user$project$LineChart_Junk$custom = _user$project$Internal_Junk$Config;
...
var _user$project$LineChart_Axis_Tick$format = function (_p6) {
	var _p7 = _p6;
	var _p9 = _p7.timestamp;
	var _p8 = _p7.change;
	if (_p8.ctor === 'Just') {
		return A2(_user$project$LineChart_Axis_Tick$formatBold, _p8._0, _p9);
	} else {
		return A2(_user$project$LineChart_Axis_Tick$formatNorm, _p7.interval.unit, _p9);
	}
};
...
var _user$project$LineChart_Axis_Tick$Time = F3(
	function (a, b, c) {
		return {change: a, interval: b, timestamp: c};
	});
...
var _user$project$Internal_Axis_Range$custom = function (editRange) {
	return _user$project$Internal_Axis_Range$Custom(
		function (range) {
			var _p10 = editRange(range);
			var min = _p10._0;
			var max = _p10._1;
			return A2(_user$project$LineChart_Coordinate$Range, min, max);
		});
};
					...
					if (_p15.ctor === '::') {
						if (_p15._1.ctor === '::') {
							...
							var _v16 = {ctor: '::', _0: _p16, _1: _p15._1._1},
								_v17 = A3(_user$project$Internal_Axis_Values_Time$getUnitChange, unit, _p17, _p16),
								_v18 = {
								ctor: '::',
								_0: A2(toTime, unitChange, _p17),
								_1: acc
							};
							values = _v16;
							unitChange = _v17;
							...
							return {
								ctor: '::',
								_0: A2(toTime, unitChange, _p15._0),
								_1: acc
							};
						}
					} else {
...
var _user$project$Internal_Axis_Values$getBeginning = F2(
	function (min, interval) {
		var multiple = A2(
			_user$project$Internal_Axis_Values$correctFloat,
			_user$project$Internal_Axis_Values$getPrecision(interval) + 1,
			min / interval);
		return _elm_lang$core$Native_Utils.eq(
			multiple,
			_elm_lang$core$Basics$toFloat(
...
var _user$project$Internal_Axis_Values$values = F4(
	function (allowDecimals, exact, amountRough, range) {
		...
		var beginning = A2(_user$project$Internal_Axis_Values$getBeginning, range.min, interval);
		return A5(
...
var _user$project$Internal_Axis_Line$full = _user$project$Internal_Axis_Line$custom(
	F2(
		function (data, range) {
...
var _user$project$Internal_Axis_Line$rangeFrame = _user$project$Internal_Axis_Line$custom(
	F2(
		function (data, range) {
...
var _user$project$Internal_Axis_Line$default = _user$project$Internal_Axis_Line$rangeFrame;
...
var _user$project$Internal_Axis_Intersection$default = A2(_user$project$Internal_Axis_Intersection$custom, _user$project$Internal_Axis_Intersection$towardsZero, _user$project$Internal_Axis_Intersection$towardsZero);
...
var _user$project$Internal_Axis_Title$custom = _user$project$Internal_Axis_Title$Config;
var _user$project$Internal_Axis_Title$at = F3(
	function (position, offset, title) {
		return _user$project$Internal_Axis_Title$custom(
			{
				view: A2(_user$project$Internal_Svg$label, 'inherit', title),
				position: position,
				offset: offset
			});
	});
var _user$project$Internal_Axis_Title$default = _user$project$Internal_Axis_Title$at(
	F2(
		function (_p2, range) {
			return range.max;
		}));
var _user$project$Internal_Axis_Title$atDataMax = _user$project$Internal_Axis_Title$at(
	F2(
		function (data, range) {
...
var _user$project$Internal_Axis$attributesLine = function (_p16) {
	var _p17 = _p16;
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_p17.events,
...
var _user$project$Internal_Axis$viewVerticalAxisLine = F3(
	function (system, axisPosition, config) {
		return A5(
			_user$project$Internal_Svg$vertical,
			system,
			_user$project$Internal_Axis$attributesLine(config),
			axisPosition,
			config.start,
			config.end);
	});
					...
					_0: _user$project$Internal_Svg$transform(
						{
							...
							_1: {
								ctor: '::',
								_0: A2(_user$project$Internal_Svg$offset, xOffset - 20, yOffset - 20),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
					...
					_0: _user$project$Internal_Svg$transform(
						{
							...
							_1: {
								ctor: '::',
								_0: A2(_user$project$Internal_Svg$offset, xOffset + 5, yOffset + 20),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
...
var _user$project$Internal_Axis$default = F3(
	function (pixels, title, variable) {
		return _user$project$Internal_Axis$custom(
			{
				title: A2(
					_user$project$Internal_Axis_Title$atDataMax,
				...
				axisLine: _user$project$Internal_Axis_Line$rangeFrame,
...
var _user$project$Internal_Axis$full = F3(
	function (pixels, title, variable) {
		return _user$project$Internal_Axis$custom(
			{
				title: A2(
					_user$project$Internal_Axis_Title$default,
					{ctor: '_Tuple2', _0: 0, _1: 0},
					title),
				...
				pixels: pixels,
				range: A2(_user$project$Internal_Axis_Range$padded, 0, 20),
				axisLine: _user$project$Internal_Axis_Line$full,
				ticks: _user$project$Internal_Axis_Ticks$custom(
					F2(
						function (data, range) {
...
var _user$project$Internal_Dots$view = F2(
	function (_p13, data) {
		var _p14 = _p13;
		var _p15 = _p14.dotsConfig;
		var config = _p15._0;
		var _p16 = config.isHovered(data.user) ? config.hovered : config.normal;
		var style = _p16._0;
		return A5(_user$project$Internal_Dots$viewShape, _p14.system, style, _p14.shape, _p14.color, data.point);
	});
...
var _user$project$Internal_Dots$hoverable = _user$project$Internal_Dots$Config;
...
var _user$project$Internal_Dots$static = function (style) {
	return _user$project$Internal_Dots$Config(
		{
			normal: style,
			hovered: A3(_user$project$Internal_Dots$aura, 5, 4, 0.5),
			isHovered: _elm_lang$core$Basics$always(false)
		});
};
...
var _user$project$Internal_Dots$default = _user$project$Internal_Dots$Config(
	{
		normal: A2(_user$project$Internal_Dots$disconnected, 10, 2),
		hovered: A3(_user$project$Internal_Dots$aura, 7, 4, 0.5),
		isHovered: _elm_lang$core$Basics$always(false)
	});
var _user$project$Internal_Dots$Bordered = function (a) {
	return {ctor: 'Bordered', _0: a};
};
var _user$project$Internal_Dots$bordered = F2(
	function (radius, border) {
		return A2(
			_user$project$Internal_Dots$style,
			radius,
			_user$project$Internal_Dots$Bordered(border));
	});
...
var _user$project$Internal_Grid$viewDots = F4(
	function (system, verticals, horizontals, color) {
		var dot = F2(
			function (x, y) {
				return A2(
		...
		return A2(
			_elm_lang$core$List$map,
			_user$project$Internal_Svg$gridDot(color),
			dots);
	});
var _user$project$Internal_Grid$view = F4(
	function (system, xAxis, yAxis, grid) {
		...
		var _p0 = grid;
		if (_p0.ctor === 'Dots') {
			return A4(_user$project$Internal_Grid$viewDots, system, verticals, horizontals, _p0._0);
		} else {
...
var _user$project$Internal_Grid$Dots = function (a) {
	return {ctor: 'Dots', _0: a};
};
		...
		var handle = F3(
			function (mouseX, mouseY, _p3) {
				...
				return A3(
					...
					data,
					system,
					A2(_user$project$LineChart_Coordinate$Point, mouseX - _p4.left, mouseY - _p4.top));
			});
		return A4(
			_elm_lang$core$Json_Decode$map3,
			handle,
	...
	function (points, system, searched) {
		...
		var getClosest = F2(
			function (point, allClosest) {
				var _p5 = _elm_lang$core$List$head(allClosest);
				if (_p5.ctor === 'Just') {
					var _p6 = _p5._0;
					return _elm_lang$core$Native_Utils.eq(_p6.point.x, point.point.x) ? {ctor: '::', _0: point, _1: allClosest} : ((_elm_lang$core$Native_Utils.cmp(
						distanceX_(_p6.point),
...
var _user$project$Internal_Events$toContainerAttributes = F3(
	function (data, system, _p7) {
		var _p8 = _p7;
		var order = function (_p9) {
			var _p10 = _p9;
			return _p10._0 ? _elm_lang$core$Maybe$Just(
				A2(_p10._1, data, system)) : _elm_lang$core$Maybe$Nothing;
		};
		return A2(_elm_lang$core$List$filterMap, order, _p8._0);
	});
var _user$project$Internal_Events$toChartAttributes = F3(
	function (data, system, _p11) {
		var _p12 = _p11;
		var order = function (_p13) {
			var _p14 = _p13;
			return _p14._0 ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(
				A2(_p14._1, data, system));
		};
		return A2(_elm_lang$core$List$filterMap, order, _p12._0);
	});
...
var _user$project$Internal_Events$getWithinX = function (radius) {
	return _user$project$Internal_Events$Decoder(
		F3(
			function (points, system, searchedSvg) {
				var searched = A2(_user$project$LineChart_Coordinate$toData, system, searchedSvg);
				var keepIfEligible = function (_p17) {
					return A4(
...
var _user$project$Internal_Events$on = F4(
	function (catchOutsideChart, event, toMsg, decoder) {
		return A2(
			_user$project$Internal_Events$Event,
			catchOutsideChart,
			F2(
...
var _user$project$Internal_Events$onClick = A2(_user$project$Internal_Events$on, false, 'click');
...
var _user$project$Internal_Events$onMouseMove = A2(_user$project$Internal_Events$on, false, 'mousemove');
var _user$project$Internal_Events$hover = function (msg) {
	return _user$project$Internal_Events$custom(
		{
			ctor: '::',
...
var _user$project$Internal_Events$onMouseDown = A2(_user$project$Internal_Events$on, false, 'mousedown');
var _user$project$Internal_Events$onMouseUp = A2(_user$project$Internal_Events$on, false, 'mouseup');
var _user$project$Internal_Events$onWithOptions = F5(
	function (options, catchOutsideChart, event, toMsg, decoder) {
		return A2(
			_user$project$Internal_Events$Event,
			catchOutsideChart,
			F2(
...
var _user$project$LineChart_Area$none = _user$project$Internal_Area$none;
var _user$project$LineChart_Area$default = _user$project$LineChart_Area$none;
			...
			function (first, rest, last) {
				return A3(
					_user$project$Internal_Utils$concat,
					{
						...
						_1: {
							ctor: '::',
							_0: _user$project$Internal_Path$Line(first.point),
							_1: {ctor: '[]'}
						}
					},
					interpolation,
...
var _user$project$Internal_Legends$defaultLegend = F5(
	function ($arguments, hovered, index, _p0, data) {
		var _p1 = _p0;
		var printYValue = function (value) {
			var _p2 = $arguments.y(value);
			if (_p2.ctor === 'Nothing') {
				return ': Unknown';
			} else {
				return A2(
		...
		var hoveredData = _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				A2(_elm_lang$core$Basics$flip, _elm_lang$core$List$member, hovered),
				A2(
					_elm_lang$core$List$map,
					function (_) {
						return _.user;
					...
					data)));
		var hoveredText = function () {
			var _p3 = hoveredData;
			if (_p3.ctor === 'Nothing') {
				return '';
			} else {
				return printYValue(_p3._0);
			}
		}();
		return A2(
			_elm_lang$svg$Svg$g,
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								_user$project$Internal_Svg$label,
								'inherit',
								A2(_elm_lang$core$Basics_ops['++'], _p1.label, hoveredText)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Internal_Legends$defaultLegends = F6(
	function (toX, toY, hovered, $arguments, system, legends) {
		var viewLegends = _user$project$Internal_Utils$indexedMap2(
			A2(_user$project$Internal_Legends$defaultLegend, $arguments, hovered));
		return A2(
			_elm_lang$svg$Svg$g,
			{
				ctor: '::',
					...
					_0: _user$project$Internal_Svg$transform(
						{
							...
							_1: {
								ctor: '::',
								_0: A2(_user$project$Internal_Svg$offset, 0, 10),
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
			...
			A2(viewLegends, legends, $arguments.data));
	});
var _user$project$Internal_Legends$viewSample = F4(
	function (_p4, sampleWidth, line, data) {
		var _p5 = _p4;
		var _p7 = _p5.system;
		var _p6 = _p5.lineConfig;
		var shape = _user$project$Internal_Line$shape(line);
		var color = A3(_user$project$Internal_Line$color, _p6, line, data);
		var dotPosition = A2(
		...
		return A2(
			...
			{
				ctor: '::',
				_0: A5(_user$project$Internal_Line$viewSample, _p6, line, _p5.area, data, sampleWidth),
				_1: {
					ctor: '::',
					_0: A6(_user$project$Internal_Dots$viewSample, _p5.dotsConfig, shape, color, _p7, data, dotPosition),
					_1: {ctor: '[]'}
				}
			});
	});
...
var _user$project$Internal_Legends$viewFree = F5(
	function (system, placement, viewLabel, line, data) {
		...
		var orderedPoints = _p8._0;
		var anchor = _p8._1;
		var xOffset = _p8._2;
		var transform = function (_p10) {
			var _p11 = _p10;
			return _user$project$Internal_Svg$transform(
				{
					ctor: '::',
					_0: A3(_user$project$Internal_Svg$move, system, _p11.x, _p11.y),
					_1: {
						ctor: '::',
		...
		var viewLegend = function (_p12) {
			var _p13 = _p12;
			return A2(
				_elm_lang$svg$Svg$g,
				{
					ctor: '::',
					_0: transform(_p13.point),
					_1: {
						ctor: '::',
						_0: _user$project$Internal_Svg$anchorStyle(anchor),
						_1: {ctor: '[]'}
...
var _user$project$Internal_Legends$viewFrees = F3(
	function (_p14, placement, view) {
		...
		return A2(
			...
			A3(
				_elm_lang$core$List$map2,
				A3(_user$project$Internal_Legends$viewFree, _p15.system, placement, view),
				_p15.lines,
				_p15.data));
	});
var _user$project$Internal_Legends$view = function ($arguments) {
	var _p16 = $arguments.legends;
	switch (_p16.ctor) {
		case 'Free':
			return A3(_user$project$Internal_Legends$viewFrees, $arguments, _p16._0, _p16._1);
		case 'Grouped':
			return A3(
...
var _user$project$LineChart$defaultConfig = F2(
	function (toX, toY) {
		return {
			y: A3(_user$project$Internal_Axis$default, 400, '', toY),
			x: A3(_user$project$Internal_Axis$default, 700, '', toX),
			...
			intersection: _user$project$Internal_Axis_Intersection$default,
			legends: _user$project$Internal_Legends$default,
			events: _user$project$Internal_Events$default,
			junk: _user$project$LineChart_Junk$default,
			grid: _user$project$Internal_Grid$default,
			area: _user$project$Internal_Area$default,
			line: _user$project$Internal_Line$default,
			dots: _user$project$Internal_Dots$default
		};
	});
var _user$project$LineChart$toSystem = F2(
	function (config, data) {
		...
		var frame = A2(_user$project$Internal_Coordinate$Frame, config.container.margin, size);
...
var _user$project$LineChart$normalize = function (dataset) {
	var _p2 = dataset;
	if (_p2.ctor === '::') {
		var _p3 = _p2._0;
		var toPercentage = F2(
				...
				while (true) {
					...
					if (_p4._0.ctor === '::') {
						if (_p4._1.ctor === '::') {
							...
							var _p6 = _p4._1._1;
							var _p5 = _p4._1._0;
							if (_elm_lang$core$Native_Utils.cmp(_p8.point.x, _p5.point.x) > 0) {
								var _v2 = prevD,
									_v3 = {ctor: '::', _0: _p8, _1: _p7},
									_v4 = _p6,
									_v5 = {
									ctor: '::',
									_0: A2(add, _p5, prevD),
						...
						if (_p4._1.ctor === '::') {
							var _p10 = _p4._1._1;
							var _p9 = _p4._1._0;
							if (_elm_lang$core$Native_Utils.cmp(prevD.point.x, _p9.point.x) < 1) {
								var _v10 = prevD,
									_v11 = {ctor: '[]'},
									_v12 = _p10,
									_v13 = {
...
var _user$project$LineChart$container = F3(
	function (config, junkHtml, plot) {
		var attributes = A2(
			_elm_lang$core$Basics_ops['++'],
			{
				ctor: '::',
...
var _user$project$LineChart$viewCustom = F2(
	function (config, lines) {
		...
		var junk = A2(
			...
			A2(_user$project$Internal_Junk$getLayers, system, config.junk));
		...
		var attributes = _elm_lang$core$List$concat(
			{
				ctor: '::',
				_0: config.container.attributesSVG,
				_1: {
					ctor: '::',
...
var _user$project$LineChart_Dots$bordered = _user$project$Internal_Dots$bordered;
var _user$project$LineChart_Dots$full = _user$project$Internal_Dots$full;
var _user$project$LineChart_Dots$hoverable = _user$project$Internal_Dots$hoverable;
var _user$project$LineChart_Dots$static = _user$project$Internal_Dots$static;
...
var _user$project$CustomLines$Info = F4(
	function (a, b, c, d) {
		return {age: a, weight: b, height: c, income: d};
	});
var _user$project$CustomLines$alice = {
	ctor: '::',
	_0: A4(_user$project$CustomLines$Info, 4, 24, 0.94, 0),
	_1: {
		ctor: '::',
		_0: A4(_user$project$CustomLines$Info, 25, 75, 1.73, 25000),
		_1: {
			ctor: '::',
			_0: A4(_user$project$CustomLines$Info, 43, 83, 1.75, 40000),
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$CustomLines$bob = {
	ctor: '::',
	_0: A4(_user$project$CustomLines$Info, 4, 22, 1.01, 0),
	_1: {
		ctor: '::',
		_0: A4(_user$project$CustomLines$Info, 25, 75, 1.87, 32000),
		_1: {
			ctor: '::',
			_0: A4(_user$project$CustomLines$Info, 43, 77, 1.87, 52000),
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$CustomLines$chuck = {
	ctor: '::',
	_0: A4(_user$project$CustomLines$Info, 4, 21, 0.98, 0),
	_1: {
		ctor: '::',
		_0: A4(_user$project$CustomLines$Info, 25, 89, 1.83, 85000),
		_1: {
			ctor: '::',
			_0: A4(_user$project$CustomLines$Info, 43, 95, 1.84, 120000),
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$CustomLines$chart = A3(
	_user$project$LineChart$view,
	function (_) {
		return _.age;
	},
	...
	{
		ctor: '::',
		_0: A4(_user$project$LineChart$line, _elm_lang$core$Color$red, _user$project$LineChart_Dots$cross, 'Alice', _user$project$CustomLines$alice),
		_1: {
			ctor: '::',
			_0: A4(_user$project$LineChart$line, _elm_lang$core$Color$blue, _user$project$LineChart_Dots$square, 'Bob', _user$project$CustomLines$bob),
			_1: {
				ctor: '::',
				_0: A4(_user$project$LineChart$line, _elm_lang$core$Color$green, _user$project$LineChart_Dots$circle, 'Chuck', _user$project$CustomLines$chuck),
				_1: {ctor: '[]'}
			}
		}
	});
var _user$project$CustomLines$main = _elm_lang$virtual_dom$Native_VirtualDom.staticProgram(
	A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _user$project$CustomLines$chart,
			_1: {ctor: '[]'}
		}));

var Elm = {};
Elm['CustomLines'] = Elm['CustomLines'] || {};
if (typeof _user$project$CustomLines$main !== 'undefined') {
    _user$project$CustomLines$main(Elm['CustomLines'], 'CustomLines', undefined);
}
