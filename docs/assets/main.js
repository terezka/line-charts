...
var _user$project$Area$ReceiveData = function (a) {
...
var _user$project$Area$generateData = function () {
	...
	return A2(
		...
		_user$project$Area$ReceiveData,
		A2(
...
var _user$project$Lines$ReceiveData = function (a) {
	return {ctor: 'ReceiveData', _0: a};
};
var _user$project$Lines$generateData = function () {
	...
	return A2(
		_user$project$Random_Pipeline$send,
		_user$project$Lines$ReceiveData,
		A2(
			_user$project$Random_Pipeline$with,
			A2(genNumbers, 70, 90),
			A2(
...
var _user$project$Selection$ReceiveData = function (a) {
	return {ctor: 'ReceiveData', _0: a};
};
var _user$project$Selection$generateData = function () {
	...
	return A2(
		_user$project$Random_Pipeline$send,
		_user$project$Selection$ReceiveData,
		A2(
			_user$project$Random_Pipeline$with,
			A2(genNumbers, -8, 8),
			A2(
...
var _user$project$Ticks$ReceiveNumbers = function (a) {
	return {ctor: 'ReceiveNumbers', _0: a};
};
var _user$project$Ticks$getNumbers = function () {
	...
	return A2(
		_elm_lang$core$Random$generate,
		_user$project$Ticks$ReceiveNumbers,
		A4(
