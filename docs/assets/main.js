	...
	return _user$project$LineChart_Line$custom(
		function (data) {
			return A2(
				...
				data) ? A2(_user$project$LineChart_Line$style, 2, _elm_lang$core$Basics$identity) : A2(_user$project$LineChart_Line$style, 1, _elm_lang$core$Basics$identity);
		});
};
...
var _user$project$Selection$xAxisRangeConfig = function (selection) {
	var end = _elm_lang$core$Native_Utils.eq(selection.start, selection.end) ? (selection.start + 1) : A2(_elm_lang$core$Basics$max, selection.start, selection.end);
	var start = A2(_elm_lang$core$Basics$min, selection.start, selection.end);
	return A2(_user$project$LineChart_Axis_Range$window, start, end);
};
	...
	function (system, selection) {
		...
		if (_p4.ctor === 'Just') {
			return {
				ctor: '::',
				_0: A6(
					_user$project$LineChart_Junk$rectangle,
					system,
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$fill('#b6b6b61a'),
						_1: {ctor: '[]'}
					},
					_p4._0.start,
					_p4._0.end,
...
var _user$project$Selection$getSelectionStart = F2(
	function (hovered, model) {
		var _p5 = model.selection;
		if (_p5.ctor === 'Just') {
			return _p5._0.start;
		} else {
			return hovered;
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				data: A3(
					...
					_user$project$Selection$toData(_p7._0),
					_user$project$Selection$toData(_p7._1),
					_user$project$Selection$toData(_p7._2))
			});
	});
	...
	function (msg, model) {
		...
		switch (_p8.ctor) {
			...
			case 'Move':
				var _p9 = _p8._0;
				if (model.dragging) {
					var start = A2(_user$project$Selection$getSelectionStart, _p9.x, model);
			...
			case 'Drop':
				...
				return _elm_lang$core$Native_Utils.eq(
					_p10.x,
					A2(_user$project$Selection$getSelectionStart, _p10.x, model)) ? A2(
					_user$project$Selection$addCmd,
					_elm_lang$core$Platform_Cmd$none,
					A2(
						_user$project$Selection$setDragging,
...
var _user$project$Selection$chartZoom = F2(
...
var _user$project$Selection$chart = function (model) {
	return A2(
		_user$project$Selection$viewChart,
		model.data,
		{
			...
			events: _user$project$LineChart_Events$custom(
				{
					...
					_0: A4(
						...
						'mousedown',
						A3(_user$project$LineChart_Events$Options, true, true, false),
					...
					_1: {
						...
						_1: {
							...
							_0: A4(
								_user$project$LineChart_Events$onWithOptions,
								'mouseup',
								A3(_user$project$LineChart_Events$Options, true, true, true),
...
var _user$project$Ticks$chart = function (model) {
	return A2(
		_user$project$LineChart$viewCustom,
		{
			...
			container: _user$project$LineChart_Container$default('line-chart-ticks'),
			interpolation: _user$project$LineChart_Interpolation$default,
			intersection: _user$project$LineChart_Axis_Intersection$default,
			legends: _user$project$LineChart_Legends$default,
			events: _user$project$LineChart_Events$hoverOne(_user$project$Ticks$Hint),
			junk: _user$project$LineChart_Junk$custom(
				function (system) {
					var middle = function (r) {
					...
					return {
						...
						above: {
							ctor: '::',
							_0: A8(
								_user$project$LineChart_Junk$labelPlaced,
								system,
								middle(system.x),
								system.y.max,
								0,
								-30,
								'middle',
								A3(_elm_lang$core$Color$rgb, 120, 120, 120),
		...
		{
			ctor: '::',
			_0: A4(_user$project$LineChart$line, _user$project$LineChart_Colors$pink, _user$project$LineChart_Dots$plus, 'Alice', model.data.alice),
			_1: {
				ctor: '::',
				_0: A4(_user$project$LineChart$line, _user$project$LineChart_Colors$purple, _user$project$LineChart_Dots$diamond, 'Bobby', model.data.bobby),
				_1: {
					ctor: '::',
					_0: A5(
						_user$project$LineChart$dash,
						_user$project$LineChart_Colors$red,
...
var _user$project$Main$updateFocused = F2(
	function (id, model) {
		return _elm_lang$core$Native_Utils.eq(id, model.focused) ? _elm_lang$core$Native_Utils.update(
			model,
			{focused: _elm_lang$core$Maybe$Nothing}) : _elm_lang$core$Native_Utils.update(
			model,
			{focused: id});
	});
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {focused: a, selection: b, area: c, stepped: d, ticks: e};
	});
...
var _user$project$Main$init = function () {
	var _p0 = _user$project$Ticks$init;
	var ticks = _p0._0;
	var cmdTicks = _p0._1;
	var _p1 = _user$project$Stepped$init;
	var stepped = _p1._0;
	var cmdStepped = _p1._1;
	var _p2 = _user$project$Area$init;
	var area = _p2._0;
	var cmdArea = _p2._1;
	var _p3 = _user$project$Selection$init;
	var selection = _p3._0;
	var cmdSelection = _p3._1;
	return {
		ctor: '_Tuple2',
		_0: {focused: _elm_lang$core$Maybe$Nothing, selection: selection, area: area, stepped: stepped, ticks: ticks},
	...
	function (msg, model) {
		...
		switch (_p4.ctor) {
			case 'Focus':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Main$updateFocused, _p4._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SelectionMsg':
				var _p5 = A2(_user$project$Selection$update, _p4._0, model.selection);
				var selection = _p5._0;
				var cmd = _p5._1;
				return {
					ctor: '_Tuple2',
			...
			case 'AreaMsg':
				var _p6 = A2(_user$project$Area$update, _p4._0, model.area);
				var area = _p6._0;
				var cmd = _p6._1;
				return {
					ctor: '_Tuple2',
			...
			case 'SteppedMsg':
				var _p7 = A2(_user$project$Stepped$update, _p4._0, model.stepped);
				var stepped = _p7._0;
				var cmd = _p7._1;
				return {
					ctor: '_Tuple2',
			...
			default:
				var _p8 = A2(_user$project$Ticks$update, _p4._0, model.ticks);
				var ticks = _p8._0;
				var cmd = _p8._1;
				return {
					ctor: '_Tuple2',
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Selection.Msg":{"args":[],"tags":{"LeaveChart":["LineChart.Coordinate.Point"],"RecieveNumbers":["( List Float, List Float, List Float )"],"Hint":["Maybe.Maybe LineChart.Coordinate.Point"],"Drop":["LineChart.Coordinate.Point"],"LeaveContainer":["LineChart.Coordinate.Point"],"Hold":["LineChart.Coordinate.Point"],"Move":["LineChart.Coordinate.Point"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Stepped.Msg":{"args":[],"tags":{"RecieveNumbers":["( List Int, List Int, List Int )"],"Hint":["Maybe.Maybe LineChart.Coordinate.Point"]}},"Main.Msg":{"args":[],"tags":{"Focus":["Maybe.Maybe Main.Id"],"TicksMsg":["Ticks.Msg"],"AreaMsg":["Area.Msg"],"SteppedMsg":["Stepped.Msg"],"SelectionMsg":["Selection.Msg"]}},"Area.Msg":{"args":[],"tags":{"RecieveNumbers":["( List Float, List Float, List Float )"],"Hint":["List LineChart.Coordinate.Point"]}},"Ticks.Msg":{"args":[],"tags":{"RecieveNumbers":["( List Float, List Float, List Float )"],"Hint":["Maybe.Maybe LineChart.Coordinate.Point"]}}},"aliases":{"LineChart.Coordinate.Point":{"args":[],"type":"{ x : Float, y : Float }"},"Main.Id":{"args":[],"type":"String"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
